...
export default function Philosophy({ lang }: PhilosophyProps) {
  ...
  return (
    <section
      id="philosophy"
      className="py-24 md:py-32 px-6 md:px-12 bg-transparent text-neutral-900 overflow-hidden relative border-b border-neutral-200/60"
    >
      ...
      <div className="max-w-[1250px] mx-auto relative z-10">
        ...
        {/* Header Grid */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-end border-b border-neutral-200 pb-12 mb-16">
          <div className="lg:col-span-8">
            ...
            <h2 className="text-3xl md:text-5xl font-display font-black tracking-tight leading-[1.1] text-neutral-950 uppercase">
              {t.philHeading}
            </h2>
          </div>
          <div className="lg:col-span-4 lg:text-right">
            ...
            <p className="text-neutral-500 text-sm font-light mt-2 max-w-[340px] lg:ml-auto leading-relaxed">
              {t.philSubtextDesc}
            </p>
          </div>
        </div>
        ...
        <div className="mb-16 bg-white border border-neutral-200 rounded-3xl p-8 flex flex-col md:flex-row items-center justify-between gap-8 shadow-sm relative overflow-hidden group">
          <div className="absolute top-0 right-0 w-32 h-32 border-b border-l border-neutral-100 pointer-events-none rounded-bl-3xl bg-neutral-50/50 flex items-center justify-center font-mono text-[10px] text-neutral-300">
            80/20 SPLIT
          </div>

          <div className="flex items-center gap-5 z-10">
            <div className="w-14 h-14 bg-brand-blue/5 rounded-2xl flex items-center justify-center text-brand-blue shrink-0 border border-brand-blue/10">
            ...
            <div>
              ...
              <h3 className="text-xl md:text-2xl font-display font-black text-neutral-950 uppercase mt-1">
                {isRu ? "80% ПОЛУЧАЕТ АРТИСТ / 20% ЛЕЙБЛ РОЯЛТИ" : "80% TO ARTIST / 20% TO THE LABEL"}
              </h3>
              <p className="text-xs md:text-sm text-neutral-500 font-light mt-1.5 max-w-[650px] leading-relaxed">
                {isRu 
          ...
          {tenets.map((tenet, idx) => {
            ...
            return (
              <motion.div
                ...
                className="bg-white p-8 md:p-10 flex flex-col justify-between group hover:bg-[#faf9fc] transition-colors duration-300 relative border border-transparent hover:border-neutral-200"
              >
                <div>
                  <div className="flex justify-between items-center mb-8">
                    <span className="font-mono text-xs text-[#7e8c9c] group-hover:text-neutral-800 transition-colors uppercase font-bold">
                      РАЗДЕЛ {tenet.number}
                    </span>
                ...
                <h3 className="font-display text-base md:text-lg font-black tracking-wide text-neutral-950 uppercase mb-4 leading-tight">
                  {tenet.title}
                </h3>
              </div>

              <p className="text-xs md:text-sm text-neutral-500 group-hover:text-neutral-700 transition-colors leading-relaxed font-light mt-6">
                {tenet.description}
              </p>
            </motion.div>
          );
        ...
        {/* Beautiful info bar */}
        <div className="mt-16 border-t border-neutral-200 pt-8 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 text-[10px] font-mono text-[#7e8c9c] tracking-wider uppercase">
